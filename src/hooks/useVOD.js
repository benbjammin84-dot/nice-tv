...
export const IA_COLLECTIONS = [
  ...
  {
    id: 'george_blood',
    name: '🎞️ George Blood Transfers',
    collection: 'georgeblood',
    description: 'Rare archival film and audio transfers by George Blood',
  },
  {
    id: 'upmaa',
    name: '🎬 UPMAA Films',
    collection: 'UPMAA_films',
    description: 'University of Pennsylvania Museum of Archaeology films',
  },
  {
    id: 'audiobooks',
